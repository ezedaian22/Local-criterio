    ...
    <Layout>
      <div className="flex flex-col gap-6 animate-fade-in">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          ...
          <div className="card flex flex-col gap-1">
            <span className="text-xs font-mono text-criterio-texto/60 uppercase tracking-widest">Mercadería recibida</span>
            <span className="text-xl font-display text-blue-400">{formatPeso(mercaderia)}</span>
          </div>
          <div className="card flex flex-col gap-1 border border-blue-800">
            <span className="text-xs font-mono text-criterio-texto/60 uppercase tracking-widest">Stock en local</span>
            <span className="text-xl font-display font-bold text-blue-300">{formatPeso(stockLocal)}</span>
          </div>
        </div>
