...
export default function EncargadaDashboard() {
  ...
  const totalIngresoCaja  = totales.ingreso_caja || 0
  const saldoCaja        = totalVentasEf - totalGastosEf - totalEntregaEf + totalIngresoCaja
    ...
    <Layout>
      <div className="flex flex-col gap-6 animate-fade-in">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          ...
          <div className="stat-card">
            <span className="stat-label">Ingresos a caja</span>
            <span className="text-xl font-display text-purple-400">{formatPeso(totalIngresoCaja)}</span>
          </div>
          <div className="stat-card">
